...
namespace HarryPotter
{
    class Hugrabug
    {
        HugrabugTanonc gyoker;
        public class HugrabugTanonc
        {
            ...
            public int kulcs;
            public HugrabugTanonc bal;
            public HugrabugTanonc jobb;
        ...
        void _Beszuras(ref HugrabugTanonc p, Varazslo tanonc, int kulcs)
        {
            if (p == null)
            {
                p = new HugrabugTanonc();
                p.kulcs = kulcs;
        ...
        bool _BenneVanE(HugrabugTanonc p, int kulcs)
        {
            if (p != null)
            {
                if (p.kulcs.CompareTo(kulcs) < 0)
        ...
        int _FaMerete(HugrabugTanonc p)
        {
            if (p == null)
            {
                return 0;
        ...
        void _Lekerdezes(HugrabugTanonc p, string tulajdonsag, int ertek)
        {
