...
namespace HarryPotter
{
    class Griffendel
    {
        GriffendelTanonc gyoker;
        public class GriffendelTanonc
        {
            ...
            public int kulcs;
            public GriffendelTanonc bal;
            public GriffendelTanonc jobb;
        ...
        void _Beszuras(ref GriffendelTanonc p, Varazslo tanonc, int kulcs)
        {
            if (p == null)
            {
                p = new GriffendelTanonc();
                p.kulcs = kulcs;
        ...
        bool _BenneVanE(GriffendelTanonc p, int kulcs)
        {
            if (p!=null)
            {
                if (p.kulcs.CompareTo(kulcs) < 0)
        ...
        int _FaMerete(GriffendelTanonc p)
        {
            if (p == null)
            {
                return 0;
        ...
        void _Lekerdezes(GriffendelTanonc p, string tulajdonsag, int ertek)
        {
